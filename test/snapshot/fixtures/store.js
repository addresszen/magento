...
(function () {
  ...
  function createInstance(defaultConfig) {
    ...
    var instance = bind$5(Axios$2.prototype.request, context);
  ...
  ***************************************************************************** */
  ...
  var Controller = /*#__PURE__*/function () {
    function Controller(options) {
      ...
      this.scope = getScope$1(this.options.scope);
  ...
  window.zenStart = function () {
    [bind$3, bind$4, bind$1, bind$2, bind].forEach(function (bind) {
      var conf = config();
      if (conf) bind(conf);
    });
  };
